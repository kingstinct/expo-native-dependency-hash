...
describe('Tests', () => {
  ...
  test('getModules', async () => {
    const modules = await getModules('src/testdata', false, ['node_modules']);
  ...
  test('getModules in monorepo', async () => {
    const modules = await getModules('src/testdata/packages-in-monorepo/package-in-monorepo', false, ['../../node_modules']);
